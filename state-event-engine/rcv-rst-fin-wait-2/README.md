...
|[rcv-rst-fin-wait-2-outside-left-insecure-ipv4](rcv-rst-fin-wait-2-outside-left-secure-ipv4.pkt "Ensure that the reception of a TCP RST with SEG.SEQ=RCV.NXT-1 in the FIN-WAIT-2 state does not affect the TCP connection")                   | Unknown             | Passed              |
|[rcv-rst-fin-wait-2-outside-left-insecure-ipv6](rcv-rst-fin-wait-2-outside-left-secure-ipv6.pkt "Ensure that the reception of a TCP RST with SEG.SEQ=RCV.NXT-1 in the FIN-WAIT-2 state does not affect the TCP connection")                   | Unknown             | Passed              |
